...
开发者工具侧，包管理器 0.51.0 已发布，新增了禁用默认软件源、支持打包工作者关闭遥测等灵活配置；软件源同步新增了对 SpacemiT K3 Pico-ITX 和 OrangePi RV2 两款设备镜像的支持。Eclipse 插件 0.1.6 beta 则针对虚拟环境交互体验进行了多项改进，目前正在测试验证中，欢迎提前尝鲜反馈；VSCode 插件本期暂未发版，团队正规划下一轮迭代。
...
RuyiSDK 包管理器 0.51.0 beta 与 Eclipse 插件 0.1.6 beta：目前正在进行功能与兼容性验证，整体测试进展顺利，预计将于本周内完成测试报告。

如您在使用上述工具过程中遇到任何问题，欢迎随时在 GitHub 或社区中反馈，您的报告将帮助我们更快地定位和修复问题。感谢大家的支持与耐心！
