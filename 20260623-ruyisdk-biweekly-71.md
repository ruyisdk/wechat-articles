...
开发者工具方面，包管理器 0.50.0 已发布，新增包大小展示、macOS 初步适配及解压模块底层重构。Eclipse 插件 0.1.4 通过测试正式发布，欢迎大家下载体验。
...
RuyiSDK 0.50 已于 2026 年 6 月 23 日发布，对应的包管理器版本也为 0.50.0。本次 RuyiSDK 包管理器的更新主要包含了以下内容：
...
- Eclipse 插件 0.1.4 计划发版测试期间 <https://api.ruyisdk.cn/releases/latest-pm> 500 故障，待测功能无法验证，故相关测试延后了一周。
...
- Ruyi 包管理器 0.50.0 已通过发版测试。详见[测试报告](https://gitee.com/yunxiangluo/ruyisdk-test/blob/master/20260623/README.md#)。
